# Generated by Django 2.1.5 on 2019-03-04 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friends', models.ManyToManyField(blank=True, to='mentee.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interest_mentee', to='mentee.Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Mentor',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('interests', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interest_mentor', to='mentee.Subject')),
            ],
        ),
        migrations.AddField(
            model_name='status',
